...
public class Pokemon extends MyObservable{
    ...
    */
    public void takeDamage(int amountOfDamage, Pokemon attacker) {
        ...
        // sets the instance variable to true for this Observable object
        setChanged();

        // Creates an instance of WhatHappened
        // passes in the attacker reference, the victim reference, a String, and amount of damage
        // that new instance of WhatHappened gets passed to the notifyObservers() method in class MyObservable
