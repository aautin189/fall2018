// import statements necessary for other
import java.util.ArrayList;
import java.util.List;
import java.util.Collections;

// import statements needed for junit testing
...
public class SortersTester 
{
  ...
  public void setup() 
  {
    ...
    // create actual array lists and assign their memory addresses to reference variables
    emptyList = new ArrayList<Dog>();
    pack = new ArrayList<Dog>();
    

    // add 10 new dog objects to our array list, pack.
